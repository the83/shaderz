// Spirograph pen — classic dense pen-line hypotrochoid for recurBOY
// Analytical approach: solves whether the curve passes through each pixel
// using law of cosines decomposition. No sample loop needed.
//
