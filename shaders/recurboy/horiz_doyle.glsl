// Doyle spiral — circle packing in log-polar space for recurBOY
// Log-polar transform maps the spiral to a sheared grid; 4 unrolled
// nearest-cell checks determine which circle each pixel belongs to
//
...
void main(void) {
    ...
    // Grid spacing: cells are h × h in log-polar space
    float h = 6.2832 / N;
    float circR2 = h * h * 0.18; // squared radius for circle test
    ...
    // Row m0: compute adjusted theta, find nearest column
    float lr0 = m0 * h;
